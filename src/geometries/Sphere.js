...
class Sphere extends Geometry {
    constructor(radius, widthSegments = 32, heightSegments = 16) {
        super();
        this.radius = radius;
        this.widthSegments = widthSegments;
        this.heightSegments = heightSegments;
        const vertices = new Float32Array(3 * this.widthSegments * (this.heightSegments + 1));
        const normals = new Float32Array(3 * this.widthSegments * (this.heightSegments + 1));
