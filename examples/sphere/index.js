import { Sphere, Mesh, PerspectiveCamera, Scene, SolidColor, BlinnPhong, Rasterizer, AmbientLight, PointLight, } from '../../src/index.js';
...
renderer.init().then(() => {
    ...
    function frame() {
        ...
        i++;
        vec3.set(Math.sin(i / 100) * 2, 0, Math.cos(i / 100) * 2, pointLight.localPosition);
        vec3.set(Math.sin(i / 100) * 2, 0, Math.cos(i / 100) * 2, lightBulb.localPosition);
