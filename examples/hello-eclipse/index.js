import { Box, Mesh, PerspectiveCamera, Scene, SolidColor, BlinnPhong, Rasterizer, AmbientLight, PointLight, } from '../../src/index.js';
...
renderer.init().then(() => {
    ...
    for (let i = 0; i < 50; i++) {
        const cube = new Mesh(box, new BlinnPhong(vec3.random(), vec3.random(), Math.random() * 100));
